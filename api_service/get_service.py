...
generate_NBA_stats_url_by_year = lambda year: f"http://b8c40s8.143.198.70.30.sslip.io/api/PlayerDataTotals/query?season={year}&&pageSize=1000"
...
def _get_nba_stats_by_year(year):
    url = generate_NBA_stats_url_by_year(year)
